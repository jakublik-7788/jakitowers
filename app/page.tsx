...
import { FooterModals, useContactModal } from "./components/FooterModals";
        ...
        <div className="md:hidden space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <motion.a
              ...
              transition={{ delay: 0.5 }}
              onClick={() => play("click")}
              className="flex flex-col items-center gap-2 px-4 py-4 rounded-2xl bg-zinc-900/60 border border-white/8 hover:border-white/18 hover:bg-zinc-900 transition-all duration-200 group"
            >
