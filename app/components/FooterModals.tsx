...
const TOPICS = [
  {
    id: "song",
    label: "Brakująca piosenka",
    icon: Music,
    desc: "Chcę zgłosić piosenkę do dodania",
  },
  {
    id: "bug",
    label: "Błąd w grze",
    icon: Bug,
    desc: "Coś nie działa jak powinno",
  },
  {
    id: "idea",
    label: "Pomysł",
    icon: Lightbulb,
    desc: "Mam pomysł na nową funkcję",
  },
  {
    id: "praise",
    label: "Pochwała",
    icon: Heart,
    desc: "Chcę napisać coś miłego",
  },
    ...
    changes: [
      {
        ...
        title: "JEB*Ć RAKA",
        description:
          "Walczymy z rakiem i przyłączamy się do zbiórki pieniędzy dla chorych dzieci z fundacji Cancer Fighters. Każda wpłata na buycoffee z dzisiejszego dnia (28.04) zostanie przekazana na zbiórkę. Miłej gry!",
      },
    ],
  },
  {
    ...
    changes: [
      {
        ...
        description:
          "Wybierz tryb gry bezpośrednio ze strony głównej. Nawiguj po dniach strzałkami lub kalendarzem i wracaj do poprzednich wyzwań.",
      },
      {
        type: "new",
        title: "Tryb KLASYKI",
        description:
          "Odgaduj kultowe polskie piosenki po wersach tekstu. Dostępny jako codzienny challenge od dnia 18 i w trybie Non-Limit.",
      },
      {
        type: "new",
        title: "Tryb SOUNDTRACKI",
        description:
          "Odgaduj ścieżki dźwiękowe z filmów, seriali i gier po krótkim fragmencie audio — zaczynasz od 1 sekundy! Dostępny jako codzienny challenge od dnia 18 i w trybie Non-Limit.",
      },
      {
        type: "new2",
        title: "Podpowiedzi w trybie SOUNDTRACKI",
        description:
          "Po każdej nieudanej próbie odkrywasz nową wskazówkę: rodzaj → gatunek → rok wydania → reżyser / studio.",
      },
      {
        type: "new2",
        title: "Wygląd UI",
        description:
          "Nowy odświeżony wygląd strony. Starałem się aby był on intuicyjny i łatwy w użytkowaniu.",
      },
      {
        type: "improvement",
        title: "NON-LIMIT z nowymi trybami",
        description:
          "RAP, KLASYKI i SOUNDTRACKI w jednym miejscu. Przełączaj się między trybami bez wychodzenia z gry.",
      },
      {
        type: "improvement",
        title: "Ulepszona wyszukiwarka",
        description:
          "Możliwość odrzucenia odpowiedzi które uważamy za błędne. (Można je przywrócić)",
      },
      {
        type: "improvement",
        title: "Ulepszony odtwarzacz",
        description:
          "Użytkownik może wybrać, od którego wersu ma rozpocząć się odtwarzanie.",
      },
      {
        type: "improvement",
        title: "Nawigacja na urządzeniach mobilnych",
        description:
          "Od teraz można używać swipe do przechodzenia między dniami na stronie głownej oraz na poszczególnych trybach.",
      },
      {
        type: "fix",
        title: "Mobile UI",
        description: "Poprawione UI na urządzeniach mobilnych.",
      },
    ],
  },
];
    ...
    >
      ...
      {footer && (
        <div className="px-6 py-4 border-t border-white/5 shrink-0 flex items-center justify-between">
          <p className="text-[10px] text-zinc-700 tracking-wider font-bold uppercase">
            jakitowers.pl
          </p>
          {footer}
        </div>
...
const AboutContent = () => (
  <div className="flex flex-col gap-5 text-zinc-300 text-sm leading-relaxed">
    <div className="bg-accent/8 border border-accent/20 rounded-2xl p-5">
      <p className="text-accent text-[9px] font-black tracking-[0.3em] uppercase mb-2">
        Muzyczny projekt hobbystyczny
      </p>
    ...
    <p>
      Projekt tworzę sam, z pomocą znajomych, którzy cały czas pomagają
      wyłapywać błędy i podsuwają nowe pomysły. To projekt hobbystyczny zrobiony
      po to, żeby dać ludziom chwilę odmóżdżenia.
    </p>
    <div>
      <p className="text-white font-black uppercase tracking-widest text-[10px] mb-2">
        Dlaczego zacząłem tworzyć stronę?
      </p>
      <p>
        Strona powstała żeby dać każdemu możliwość odetchnięcia od codziennej
        pracy, obowiązków lub po prostu umilenia czasu w ciągu dnia.
      </p>
    </div>
  </div>
);
  ...
  <div className="flex flex-col gap-5 text-zinc-300 text-sm leading-relaxed">
    <div className="grid grid-cols-3 gap-2 text-xs mb-1">
      {[
        ...
        >
          <p className="text-white font-black text-[9px] uppercase tracking-wider mb-1">
            {item.label}
          </p>
    ...
    {[
      {
        ...
        body: "JakiTowers to darmowy serwis rozrywkowy o charakterze muzycznym. Korzystanie z podstawowych funkcji serwisu jest zawsze bezpłatne.",
      },
      {
        n: "2",
        title: "Prawa autorskie",
        body: "Układ strony, identyfikacja wizualna i materiały przygotowane specjalnie dla serwisu są własnością JakiTowers. Prawa do utworów muzycznych należą do ich odpowiednich właścicieli.",
      },
      {
        n: "3",
        title: "Fragmenty tekstów i audio",
        body: "Fragmenty tekstów i nagrań audio wykorzystywane są na podstawie prawa cytatu (art. 29 ustawy o prawie autorskim). Celem serwisu jest rozrywka i popularyzacja muzyki.",
      },
      {
        n: "4",
        title: "Zasady korzystania",
        body: "Z serwisu należy korzystać zgodnie z jego przeznaczeniem. Zabrania się podejmowania prób obchodzenia zabezpieczeń serwisu lub korzystania z niego niezgodnie z prawem.",
      },
      {
        n: "5",
        title: "Darmowy dostęp",
        body: "Korzystanie z JakiTowers jest zawsze darmowe. Jakiekolwiek formy wsparcia finansowego są w pełni dobrowolne i nie wpływają na dostęp do żadnych funkcji.",
      },
      {
        n: "6",
        title: "Odpowiedzialność",
        body: "Dokładamy starań, aby serwis działał stabilnie, ale nie gwarantujemy nieprzerwanej dostępności wszystkich funkcji.",
      },
      {
        n: "7",
        title: "Kontakt i zgłoszenia",
        body: "W sprawach związanych z działaniem serwisu lub prawami autorskimi możesz skontaktować się z nami przez formularz kontaktowy.",
      },
    ].map((s) => (
      <div key={s.n}>
        <p className="text-white font-black uppercase tracking-widest text-[10px] mb-1.5">
          {s.n}. {s.title}
        </p>
        <p className="text-zinc-400">{s.body}</p>
      </div>
    ))}
    <p className="text-zinc-700 text-[10px] border-t border-white/5 pt-3">
  ...
  <div className="flex flex-col gap-5 text-zinc-300 text-sm leading-relaxed">
    <div className="bg-green-500/8 border border-green-500/20 rounded-2xl p-4">
      ...
      <p className="text-zinc-300 text-xs">
        Serwis nie zbiera, nie przetwarza ani nie przechowuje danych osobowych
        użytkowników. Nie wymagamy rejestracji ani logowania.
      </p>
    </div>
    {[
      {
        title: "Dane lokalne (localStorage)",
        body: "Wyniki gry, historia prób i preferencje zapisywane są wyłącznie lokalnie w przeglądarce — tylko na Twoim urządzeniu, nigdy na serwerze.",
      },
      {
        title: "Formularz kontaktowy",
        body: "Jeśli napiszesz do nas, wiadomość trafia przez Formspree. Nie zbieramy adresów e-mail ani danych identyfikacyjnych — chyba że sam je podasz.",
      },
      {
        title: "YouTube",
        body: "Po zakończeniu rundy możemy wyświetlić teledysk z YouTube (Google LLC). YouTube może zbierać dane zgodnie z własną polityką prywatności Google.",
      },
      {
        title: "Prawa autorskie",
        body: "Fragmenty tekstów wykorzystywane są na podstawie prawa cytatu (art. 29 ustawy o prawie autorskim). Wszelkie prawa do muzyki należą do ich twórców i wydawców.",
      },
      {
        title: "Kontakt",
        body: "W razie pytań lub zgłoszenia naruszenia praw — skontaktuj się z nami przez formularz kontaktowy na stronie.",
      },
    ].map((s) => (
      <div key={s.title}>
        <p className="text-white font-black uppercase tracking-widest text-[10px] mb-1.5">
...
const CookiesContent = () => (
  <div className="flex flex-col gap-5 text-zinc-300 text-sm leading-relaxed">
    ...
    <div>
      <p className="text-white font-black uppercase tracking-widest text-[10px] mb-3">
        Co przechowujemy (localStorage)
      </p>
      <div className="flex flex-col gap-2">
        {[
          [
            "Historia wyników",
            "Żebyś widział swoje poprzednie wyniki w kalendarzu",
            "jakitowers_*_results",
          ],
          ["Stan gry", "Żeby móc wrócić do przerwanej gry", "jakitowers_day_*"],
          ["Głośność", "Żeby pamiętać ustawioną głośność", "jakitowers_volume"],
          [
            "Kolor akcentu",
            "Żeby zapamiętać wybrany kolor interfejsu",
            "jakitowers_accent_color",
          ],
          [
            "Seen states",
            "Żeby nie pokazywać zasad za każdym razem",
            "jakitowers_rules_seen_*",
          ],
        ].map(([name, desc, key]) => (
          <div
            key={name}
            className="flex gap-3 items-start bg-white/3 border border-white/5 rounded-xl p-3"
          >
    ...
    <div>
      ...
      <p className="text-zinc-400">
        Możesz wyczyścić wszystkie dane w ustawieniach przeglądarki lub przez
        DevTools:{" "}
...
const PatchContent = () => {
  ...
  const selectedPatch =
    PATCH_ENTRIES.find((p) => p.id === selectedId) || PATCH_ENTRIES[0];
      ...
      <div className="md:w-2/3 flex flex-col gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-accent text-[9px] font-black tracking-widest">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 mb-1.5">
                  <span
                    className={`text-[8px] font-black tracking-widest uppercase px-2 py-0.5 rounded-full border ${style.bg} ${style.text} ${style.border}`}
                  >
                    {style.label}
                  </span>
                </div>
            ...
            <h2 className="text-base font-[1000] italic uppercase tracking-tight text-white leading-none">
              {step === "sent"
                ...
                : step === "form" && selectedTopic
                  ? selectedTopic.label.toUpperCase()
                  : "NAPISZ DO NAS"}
            </h2>
          </div>
          <button
          ...
          <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="w-7 h-7 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center text-zinc-500 hover:text-white transition-all"
                  >
                    <ChevronLeft size={14} />
                  </button>
                  {selectedTopic && (
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    placeholder={
                      topic === "song"
                        ? "Podaj tytuł i artystę piosenki..."
                        : topic === "bug"
                          ? "Opisz co się dzieje i gdzie..."
                          : topic === "idea"
                            ? "Opisz swój pomysł..."
                            : topic === "praise"
                  ...
                  />
                  <p className="text-zinc-700 text-[10px] text-right">
                    {message.length}/500
                  </p>
                </div>
            ...
            {step === "sent" && (
              ...
              >
                ...
                <div>
                  <p className="text-white font-[1000] text-2xl uppercase italic tracking-tight">
                    Wysłano!
                  </p>
...
export const openContactModal = () => {
  if (globalOpenContact) globalOpenContact();
};
...
export const FooterModals = () => {
  ...
  return (
    <>
      ...
      <div
        className="mx-auto mt-1 opacity-60 hover:opacity-100 transition-opacity"
        style={{ maxWidth: "320px", maxHeight: "50px", overflow: "hidden" }}
      >
        <AdSense
          adSlot="1933421005"
          adFormat="horizontal"
